        ...
        <div class="max-w-7xl mx-auto  flex flex-col md:flex-row justify-start md:justify-between gap-4 mt-10 items-center">
            ...
            <div class="bg-white p-4 w-[400px] flex flex-col items-center justify-center">
                ...
                <div class="flex flex-col sm:flex-row gap-4 mt-4">
                    <button class="bg-blue-500 text-white font-bold px-4 py-2 rounded">
                        BOOK THIS TRIP
                    </button>
                    <button
                        class="text-blue-700 border border-blue-500 font-semibold px-4 py-2 rounded hover:bg-blue-500 hover:text-white transition-colors duration-500">
                        CUSTOMIZE TRIP
                    </button>
                </div>
            </div>
