...
@section('content')
<div class="container py-12 max-w-7xl mx-auto px-4 mb-20 mt-[120px]">
    <!-- Gallery Header -->
    <div class="text-center mb-12">
        <h1 class="text-4xl md:text-5xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-500">
            Our Gallery
        </h1>
        <p class="text-lg text-gray-600 max-w-2xl mx-auto">
            Explore our collection of memorable moments and beautiful creations
        </p>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        @foreach($galleries as $index => $gallery)
            <div class="group relative overflow-hidden rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 ease-in-out transform hover:-translate-y-1 cursor-pointer"
    ...
    <div id="lightbox" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/90 p-4 cursor-pointer"
        ...
        <button onclick="closeLightbox()" class="absolute top-6 right-6 text-white hover:text-gray-300 focus:outline-none z-10 transition-opacity hover:opacity-80">
        ...
        <div class="max-w-full max-h-full flex justify-center items-center">
            <img id="lightbox-image" class="max-w-[90vw] max-h-[90vh] object-contain transform transition-all duration-500 ease-[cubic-bezier(0.2,0.85,0.4,1.3)]" src="" alt="">
        </div>
    </div>
</div>
