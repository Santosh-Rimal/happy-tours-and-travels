...
<div class="bg-gray-800 rounded-lg shadow-lg p-6 max-w-4xl mx-auto">
    <h2 class="text-2xl font-bold mb-6 text-white">Edit Blog Post</h2>

    <form class="space-y-6" action="{{ route('admin.blogs.update', $blog) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div>
            ...
            @if($blog->image)
                <div class="mb-3 flex items-center space-x-4">
                    <img src="{{ asset('storage/'.$blog->image) }}" class="w-24 h-24 object-cover rounded-md border border-gray-600">
