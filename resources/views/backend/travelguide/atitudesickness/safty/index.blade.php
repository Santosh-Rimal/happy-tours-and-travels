        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden border border-gray-200 dark:border-gray-700">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-indigo-700 px-6 py-8">
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <div>
                        <h1 class="text-2xl font-bold text-white">Safety Measures</h1>
                    ...
                    <a class="bg-white/10 hover:bg-white/20 text-white px-5 py-2.5 rounded-lg transition duration-300 flex items-center gap-2 shadow-md backdrop-blur-sm"
                       href="{{ route('admin.safetymeasures.create') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd" d="M10 5a1 1 0 011 1v3h3a1 1 0 110 2h-3v3a1 1 0 11-2 0v-3H6a1 1 0 110-2h3V6a1 1 0 011-1z" clip-rule="evenodd" />
                        </svg>
                        Add New Safety Measure
                    </a>
                </div>
            </div>
            ...
            <div class="p-6">
                ...
                @if($safties->isEmpty())
                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-8 text-center">
                        ...
                        <h3 class="mt-4 text-lg font-medium text-gray-800 dark:text-gray-200">No Safety Measures Found</h3>
                        <p class="mt-1 text-gray-600 dark:text-gray-400">Get started by creating your first safety measure</p>
                    </div>
                @else
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                @foreach ($safties as $safe)
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200">{{ $safe->title }}</td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                                            <div class="flex space-x-2">
                                                <a href="{{ route('admin.safetymeasures.edit', $safe) }}" 
                                                ...
                                                <form action="{{ route('admin.safetymeasures.destroy', $safe) }}" method="POST">
                                                    ...
                                                    <button type="submit" 
                                                            ...
                                                            title="Delete"
                                                            onclick="return confirm('Are you sure you want to delete this safety measure?')">
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
