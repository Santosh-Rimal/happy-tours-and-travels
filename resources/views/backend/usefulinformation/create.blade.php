...
@section('content')
    ...
    <div class="bg-gray-800 rounded-lg shadow p-6 max-w-4xl mx-auto">
        <h2 class="text-2xl font-bold mb-6">Create New Trip Useful Information</h2>
        ...
        <form class="space-y-6" action="{{ route('admin.usefulinformations.store') }}" method="POST"
            ...
            <fieldset>
                <legend class="text-xl font-semibold flex items-center space-x-3">
                    ...
                    <span>Useful Information about Trip</span>
                </legend>
                ...
                <div class="bg-gray-700 rounded-lg p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea class="ckeditor  @error('description') border-red-500 @else border-gray-500 @enderror rounded-md px-3 py-2"
