...
@section('content')
    <div class="bg-gray-800 rounded-lg shadow p-6 max-w-4xl mx-auto">
        ...
        <form class="space-y-6" action="{{ route('admin.tripdetails.update', $tripdetail->id) }}" enctype="multipart/form-data"
            method="POST">
            @csrf
            @method('PUT')
                ...
                <div class="bg-gray-700 rounded-lg p-6 space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input
                                ...
                                type="text" name="trip_name" value="{{ old('trip_name', $tripdetail->trip_name) }}"
                                required>
                            @error('trip_name')
                        ...
                        <div>
                            ...
                            <select
                                ...
                                @foreach ($categories as $id => $category)
                                    <option value="{{ $id }}"
                                        {{ old('category_id', $tripdetail->category_id) == $id ? 'selected' : '' }}>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                type="text" name="destination" value="{{ old('destination', $tripdetail->destination) }}"
                                required>
                            @error('destination')
                                <span class="text-red-400 text-sm mt-1 block">{{ $message }}</span>
                            @enderror
                        ...
                        <div>
                            ...
                            <select
                                ...
                                <option value="Trekking" @selected(old('trip_style', $tripdetail->trip_style) == 'Trekking')>Trekking</option>
                                <option value="Peak Climbing" @selected(old('trip_style', $tripdetail->trip_style) == 'Peak Climbing')>Peak Climbing</option>
                                <option value="Tour" @selected(old('trip_style', $tripdetail->trip_style) == 'Tour')>Tour</option>
                                <option value="Expedition" @selected(old('trip_style', $tripdetail->trip_style) == 'Expedition')>Expedition</option>
                            </select>
                            @error('trip_style')
                                <span class="text-red-400 text-sm mt-1 block">{{ $message }}</span>
                            @enderror
                        ...
                        <div>
                            ...
                            <input
                                ...
                                value="{{ old('trip_duration', $tripdetail->trip_duration) }}" required>
                            @error('trip_duration')
                                <span class="text-red-400 text-sm mt-1 block">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <input
                                    ...
                                    type="text" name="food" value="{{ old('food', $tripdetail->food) }}" required>
                                @error('food')
                                    <span class="text-red-400 text-sm mt-1 block">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('transportation', $tripdetail->transportation) }}" required>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('accommodation', $tripdetail->accommodation) }}" required>
                                @error('accommodation')
                                    <span class="text-red-400 text-sm mt-1 block">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('group_size', $tripdetail->group_size) }}" required>
                                @error('group_size')
                                    <span class="text-red-400 text-sm mt-1 block">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    <option value="Easy" @selected(old('trip_difficulty', $tripdetail->trip_difficulty) == 'Easy')>Easy</option>
                                    <option value="Moderate" @selected(old('trip_difficulty', $tripdetail->trip_difficulty) == 'Moderate')>Moderate</option>
                                    <option value="Challenging" @selected(old('trip_difficulty', $tripdetail->trip_difficulty) == 'Challenging')>Challenging</option>
                                    <option value="Difficult" @selected(old('trip_difficulty', $tripdetail->trip_difficulty) == 'Difficult')>Difficult</option>
                                </select>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('trip_price', $tripdetail->trip_price) }}" required>
                                @error('trip_price')
                                    <span class="text-red-400 text-sm mt-1 block">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    type="text" name="max_elevation"
                                    value="{{ old('max_elevation', $tripdetail->max_elevation) }}" required>
                                @error('max_elevation')
                                    <span class="text-red-400 text-sm mt-1 block">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            name="trip_description" rows="6" required>{{ old('trip_description', $tripdetail->trip_description) }}</textarea>
                        ...
                        @if ($tripdetail->sliderimage)
                            <div class="mb-4">
                                ...
                                <img class="w-48 h-auto rounded shadow"
                                    src="{{ asset('storage/' . $tripdetail->sliderimage) }}" alt="Current image">
                            </div>
                        @endif

                        <div class="border-2 border-dashed border-gray-500 rounded-lg p-4 text-center">
                            <input class="dropify text-white" type="file" name="sliderimage">
                        </div>
                        @error('sliderimage')
