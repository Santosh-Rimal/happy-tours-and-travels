...
@section('content')
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-blue-600 to-indigo-700 px-6 py-8">
                    <div class="flex justify-between items-center">
                        <div>
                            <h1 class="text-2xl font-bold text-white">Create About Page</h1>
                            <p class="text-blue-100 mt-1">Build your about page with customizable sections</p>
                        </div>
                ...
                <!-- Main Form -->
                <form class="px-6 py-8" method="POST" action="{{ route('admin.abouts.store') }}">
                    @csrf
                    ...
                    <!-- Sections Container -->
                    <div class="mb-8">
                        <h2 class="text-xl font-semibold text-gray-800 mb-6 pb-2 border-b border-gray-200">Page Sections
                        </h2>
    ...
    <script>
        ...
        function addContentSection() {
            ...
            const html = `
                <div class="section-card group relative bg-white rounded-xl border border-gray-200 overflow-hidden transition-all duration-200 hover:shadow-md mb-4">
                    <div class="flex items-center justify-between px-5 py-4 bg-gray-50 border-b border-gray-200">
                        ...
                        <button type="button" onclick="this.parentElement.parentElement.parentElement.remove(); checkEmptyState();" 
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500" 
                                          name="sections[${sectionIndex}][section_content]" rows="3" required></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-5">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <input class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500" 
