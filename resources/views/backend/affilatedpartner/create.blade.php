...
@section('content')
    <div class="bg-gray-800 rounded-lg shadow p-6 max-w-4xl mx-auto">
        <h2 class="text-2xl font-bold mb-6">Create New Affiliated and Partners</h2>
        ...
        <form class="space-y-6" action="{{ route('admin.affiliatedpartners.store') }}" method="POST"
            ...
            <fieldset>
                ...
                <div class="bg-gray-700 rounded-lg p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea
                            class="w-full bg-gray-600 @error('description') border-red-500 @else border-gray-500 @enderror rounded-md px-3 py-2 h-40"
            ...
            <fieldset>
                ...
                <div class="bg-gray-700 rounded-lg p-6">
                    <div class="border-2 border-dashed border-gray-500 rounded-lg p-4 text-center">
                        <input class="dropify bg-gray-600" id="hero-upload" type="file" name="image" required>
                    </div>
                    </label>
                    @error('image')
            ...
            <fieldset>
                ...
                <div class="bg-gray-700 rounded-lg p-6 space-y-6">
                    <div class="grid grid-cols-1 gap-6">
                        <div>
                            <label class="block text-sm font-medium text-gray-300 mb-1">Activity Status*</label>
                            <select
                                class="w-full bg-gray-600 border @error('status') border-red-500 @else border-gray-500 @enderror rounded-md px-3 py-2 text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                                id="" type="text" name="status" value="{{ old('status') }}" required>
                                <option selected disabled>Select Any one option</option>
