...
@section('content')
    ...
    <div class="bg-gray-800 rounded-lg shadow p-6 max-w-4xl mx-auto">
        <h2 class="text-2xl font-bold mb-6">Edit Her</h2>
        ...
        <form class="space-y-6" action="{{ route('admin.herosections.update', $herosection->id) }}" method="POST"
            ...
            <fieldset>
                ...
                <div class="bg-gray-700 rounded-lg p-6 space-y-6">
                    <div class="grid grid-cols-1 gap-6">
                        {{-- Title --}}
                        <div>
                            <label class="block text-sm font-medium text-gray-300 mb-1">Hero Section Title*</label>
                            <input
                                class="w-full bg-gray-600 border @error('herotitle') border-red-500 @else border-gray-500 @enderror rounded-md px-3 py-2 text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                                type="text" name="herotitle" value="{{ old('herotitle', $herosection->herotitle) }}"
                                required>
                            @error('herotitle')
                ...
                <div class="bg-gray-700 rounded-lg p-6 space-y-4">
                    ...
                    @if ($herosection->heroimage)
                        <div class="mb-4">
                            ...
                            <img class="w-48 h-auto rounded shadow" src="{{ asset('storage/' . $herosection->heroimage) }}"
                                alt="Current image">
                        </div>
                    @endif

                    <div class="border-2 border-dashed border-gray-500 rounded-lg p-4 text-center">
                        <input class="dropify text-white" type="file" name="heroimage">
                    </div>
                    @error('image')
