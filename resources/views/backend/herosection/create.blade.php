...
@section('title', 'Create Hero Sectin')

@section('content')
    {{-- ckdeitor --}}
    <script src="https://cdn.ckeditor.com/ckeditor5/36.0.1/super-build/ckeditor.js"></script>
    <div class="bg-gray-800 rounded-lg shadow p-6 max-w-4xl mx-auto">
        <h2 class="text-2xl font-bold mb-6">Create Hero Section</h2>
        ...
        <form class="space-y-6" action="{{ route('admin.herosections.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="grid grid-cols-1  gap-6">
                        <div>
                            ...
                            <input
                                ...
                                type="text" name="herotitle" value="{{ old('herotitle') }}" required>
                            @error('herotitle')
            ...
            <fieldset>
                ...
                <div class="bg-gray-700 rounded-lg p-6">
                    <div class="border-2 border-dashed border-gray-500 rounded-lg p-4 text-center">
                        <input class="dropify" id="hero-upload" type="file" name="heroimage" required>
                    </div>
                    </label>
                    @error('heroimage')
